...
class _CourseDetailScreenState extends State<CourseDetailScreen> {
  ...
  final Map<int, List<Map<String, dynamic>>> quizzes = {
    0: [
      {'question': "What is Flutter primarily used for?", 'options': ["Web apps", "Mobile apps", "Databases", "AI tools"], 'answer': "Mobile apps"},
      {'question': "Flutter is developed by which company?", 'options': ["Facebook", "Google", "Microsoft", "Apple"], 'answer': "Google"},
    ],
    1: [
      {'question': "What language is used in Flutter?", 'options': ["Kotlin", "Swift", "Dart", "Java"], 'answer': "Dart"},
      {'question': "Which widget manages state in Flutter?", 'options': ["StatelessWidget", "StatefulWidget", "Container", "Text"], 'answer': "StatefulWidget"},
    ],
    2: [
      {'question': "Firebase is mainly used for?", 'options': ["UI Design", "Database and Authentication", "Animations", "State Management"], 'answer': "Database and Authentication"},
    ],
  };
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("by ${widget.course['creator'] ?? 'Unknown'}",
